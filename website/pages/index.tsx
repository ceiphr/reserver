      ...
      <main className="p-5 md:my-12 max-w-3xl mx-auto">
        ...
        <div className="text-xl space-y-5">
          <p className="slide-in">
            A <span className="italic">very mild</span> contingency plan for
            servers that run out of space. Based on this great article by Brian
            Schrader:{" "}
            <a
          ...
          <p className="slide-in">
            Just like Schrader does in the article, this script will reserve
            space on a server, so, you can delete it later.
          </p>
          <p className="slide-in">
            Specifically, when your server runs out of space, you can remove the
            reservation file this script produces so that the server will
            hopefully have enough space to function again while you try to fix
            whatever caused the issue.
          </p>
          <p className="slide-in">
            You should always use monitoring software and or SaaS offerings such
            as{" "}
            <a
            ...
            to monitor disk usage on your servers. That is the tool that will{" "}
            <span className="italic">really</span> help you mitigate this
            potential problem. Think of reserver.sh as a sidekick. It&apos;s
            simple to use and is there if your primary tools somehow fail. It is
            a <span className="italic">mild</span> contingency plan if you can
          ...
          <footer className="slide-in">
            ...
            <p>
              Reserver, its installation script and this website are all{" "}
